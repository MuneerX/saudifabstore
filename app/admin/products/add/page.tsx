            ...
            <div className={styles.promoBuyBox}>
              ...
              <div className={styles.buyBoxPriceMatrix}>
                <div className={styles.fieldBlock}>
                  <label htmlFor="add-product-price" className={styles.fieldLabel}>REGULAR PRICE (SAR)</label>
                ...
                <div className={styles.fieldBlock}>
                  <label htmlFor="add-product-discount" className={styles.fieldLabel}>DISCOUNT PRICE (SAR, OPTIONAL)</label>
                  <div className={styles.priceInputWrapper}>
                    <span className={styles.currencyPrefix}>SAR</span>
                    <input
